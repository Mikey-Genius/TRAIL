...
<html>
<head>
<title>Online Recharge Sytem | index :: Patrick</title>
    ...
    <div class="container">
        ...
        <!--//logo-->
          <div class="w3layouts-login">
                <a action="process.php"  method="post" href="#"><i class="glyphicon glyphicon-user"> </i>Hi, <?php echo $_SESSION['email']; ?></a>
                <a action="logout.php"  method="post" href="account.php"><i class="glyphicon glyphicon-user"> </i>Logout</a>
            </div>    
                                    ...
                                    <div class="tab-pane" id="Registration">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9 col-sm-9 col-xs-9">
                                                        <input type="text" class="form-control" placeholder="Name" required="required" name="name" id="name"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="mobile" class="col-sm-2 control-label">
                                                Mobile</label>
                                            <div class="col-sm-10">
                                                <input type="tel" class="form-control" id="mobile" name="mobile"placeholder="Mobile" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
			    ...
			    <div class="callbacks_container">
			      <ul class="rslides" id="slider">		       
			         ...
			         <li>
			          	 <div class="banner2">
			           		<div class="caption">
					          	<h3><span>Flat GHC 5 Cash back</span>  on Movie Tickets</h3>
			...
			<div class="category-list">
				<div id="parentVerticalTab">
					...
					<ul class="resp-tabs-list hor_1">
						...
						<li><i class="icon fa fa-television" aria-hidden="true"></i>Tv Services</li>
						...
						<ol>							
                            ...
                            <li>
                                ...
                                <select class="selectpicker show-tick" data-live-search="true" required="required" >
                                  ...
                                  <option data-tokens="Tigo">Tigo</option>
                                  <option data-tokens="Airtel">Airtel</option>
                                  <option data-tokens="Mtn">Mtn</option>
                                  <option data-tokens="Glo">Glo</option>
                            ...
                            <li>
                                <div class="agileits-select">
                                <select class="selectpicker show-tick" data-live-search="true" required="required" >
                                  <option data-tokens="Select Region">Select Region</option>
                                  <option data-tokens="Greater Accra Region">Greater Accra Region</option>
                                  <option data-tokens="Central Region">Central Region</option>
                                  <option data-tokens="Western Region">Western Region</option>
                                  <option data-tokens="Western North Region">Western North Region</option>
                                  <option data-tokens="Volta Region">Volta Region</option>
                                  <option data-tokens="Ashanti Region">Ashanti Region</option>
                                  <option data-tokens="Bono Region">Bono Region</option>
                                  <option data-tokens="Ahafo Region">Ahafo Region</option>
                                  <option data-tokens="Bono East Region">Bono East Region</option>
                                  <option data-tokens="Eastern Region">Eastern Region</option>
                                  <option data-tokens="Oti Region">Oti Region</option>
                                  <option data-tokens="Upper West Region">Upper West Region</option>
                                  <option data-tokens="Upper East Region">Upper East Region</option>
                                  <option data-tokens="Northern Region">Northern Region</option>
                                  <option data-tokens="North East Region">North East Region</option>
                                  <option data-tokens="Savannah Region">Savannah Region</option>
                                </select>
                                </div>
                            </li>
                            <li>
						...
						<ol>	
                            <li>
                                ...
                                <select class="selectpicker show-tick" data-live-search="true">
                                  <option data-tokens="Select Operator">Datacard Operator</option>
                                  <option data-tokens="Tigo">Tigo</option>
                                  <option data-tokens="Surfline">Surfline</option>
                                  <option data-tokens="Busy Internet">Busy Internet</option>
                                  <option data-tokens="Airtel">Airtel</option>
                                  <option data-tokens="Mtn">Mtn</option>
                                  <option data-tokens="Glo">Glo</option>
                                  <option data-tokens="Vodafone">Vodafone</option>
                                  <option data-tokens="Apple Data">Apple Data</option>
                                  <option data-tokens="Vodafone">Vodafone</option>
                                </select>
                                </div>
                            </li>
				...
				<div>
                    ...
                    <div id="tab2" class="tab-grid">
						...
						<ol>							
							<li>
                                  <h4>TV Services </h4>
								<input type="tel" id="tel" name="tel" pattern="\d{15}" placeholder="Enter TV code" required />
								<p class="validation01">
									<span class="invalid">Please enter a valid 15 digit TV code</span>
									<span class="valid">That's what we wanted!</span>
								</p>
							</li>
                            <li>
                                <div class="agileits-select">
                                <select class="selectpicker show-tick" data-live-search="true">
                                  <option data-tokens="Select TV network">Select TV network </option>
                                  <option data-tokens="Airtel Digital TV">Airtel Digital TV </option>
                                  <option data-tokens="Dish TV">Dish TV </option>
                                  <option data-tokens="Tata Sky">Tata Sky</option>
                                  <option data-tokens="Reliance Digital TV">Reliance Digital TV</option>
                                  <option data-tokens="Sun Direct">Sun Direct</option>
                                  <option data-tokens="DsTv">DsTv</option>
                                </select>
                                </div>
                            </li>
                            <li>
                    ...
                    <div id="tab2" class="tab-grid">
						...
						<ol>	
                            <li>
                                <div class="agileits-select">
                                <select class="selectpicker show-tick" data-live-search="true">
                                  <option data-tokens="Select Provider">Select Provider</option>
                                  <option data-tokens="P D S ">P D S</option>
                                  <option data-tokens="V R A ">V R A</option>
                                </select>
                                </div>
                            </li>
                            <li>
						...
						<ol>	
                            <li>
                                ...
                                <select class="selectpicker show-tick" data-live-search="true">
                                  <option data-tokens="Select Provider">Select Provider</option>
                                  <option data-tokens="V R A">V R A</option>
                                  <option data-tokens="W C G">W C G</option>
                                </select>
                                </div>
                            </li>
                            <li>
		...
		<div class="container">
			...
			<div class="col-md-6 phone-text">
                ...
                <p class="subtitle">Simple and Fast Payments</p>
					<div class="text-1">
						<h5>Recharge</h5>
						<p>Recharge your Mobile, Datacard etc...</p>
					</div>
					<div class="text-1">
						<h5>Paybills</h5>
						<p>Pay your Bills(Electricity, Water, etc...)</p>
					</div>
					<div class="text-1">
						<h5>Book Online</h5>
						<p>Book Online Movie Tickets</p>
					</div>
	...
	<div class="w3l-support">
		<div class="container">
			...
			<div class="col-md-7 w3_agile_support_right">
				...
				<p>Can’t find the answer to your question on our Frequently Asked Questions (FAQ) page? No need to worry! You can get in touch with our customer care about any question or worry you might have. Just fill in the contact form and we’ll get in touch with you as soon as possible.</p>
			...
			<div class="container">
				<div class="w3-agile-offers">
					...
					<p>Contrary to popular belief
							,Online Recharge is not simply random recharges. You can count on us for the best offers.</p>
				</div>
			</div>
		</div>
<!--//offers-->
		...
		<h3>We are accepted at</h3>
	 		<div class="container">
				<ul>
                    ...
                    <li><a href="#"><img class="img-responsive" src="images/Wd.png" alt=""></a></li>
				</ul>
				<ul>
					...
					<li><a href="#"><img class="img-responsive" src="images/accra-logo.png" alt=""></a></li>
					<li><a href="#"><img class="img-responsive" src="images/lg8.png" alt=""></a></li>
					<li><a href="#"><img class="img-responsive" src="images/Sb.jpg" alt=""></a></li>	
				</ul>
			</div>
		</div>	
<!--//partners-->	
        ...
        <div class="w3-agile-footer-top-at">
            ...
            <div class="col-md-3 agileits-amet-sed ">
                <h4>Mobile Recharges</h4>
                    <ul class="w3ls-nav-bottom">
                        <li><a href="index.html#parentVerticalTab1">Tigo</a></li>
                        <li><a href="index.html#parentVerticalTab1">Airtel</a></li>
                        <li><a href="index.html#parentVerticalTab1">Mtn</a></li>
                        <li><a href="index.html#parentVerticalTab1">Glo</a></li>    
            ...
            <div class="col-md-3 agileits-amet-sed ">
                <h4>DATACARD RECHARGES</h4>
                   <ul class="w3ls-nav-bottom">
                        <li><a href="index.html#parentVerticalTab3">Tigo</a></li>
                        <li><a href="index.html#parentVerticalTab3">Surfline</a></li>
                        <li><a href="index.html#parentVerticalTab3">Busy Internet</a></li>
                        <li><a href="index.html#parentVerticalTab3">Airtel</a></li>
                        <li><a href="index.html#parentVerticalTab3">Mtn</a></li>
                        <li><a href="index.html#parentVerticalTab3">Glo</a></li>    
                        <li><a href="index.html#parentVerticalTab3">Vodafone</a></li>   
                        <li><a href="index.html#parentVerticalTab3">Apple Data</a></li>     
                    </ul>   
            </div>
            <div class="col-md-2 agileits-amet-sed">
                <h4>TV Service Recharges</h4>
                <ul class="w3ls-nav-bottom">
                        ...
                        <li><a href="index.html#parentVerticalTab2">DsTv Recharges</a></li> 
                    </ul>   
            </div>
            <div class="col-md-2 agileits-amet-sed ">
    ...
    <div class="w3l-footer-bottom">
        <div class="container-fluid">
            ...
            <div class="col-md-8 agileits-footer-class">
                <p >© 2024 Online Recharge. All Rights Reserved | Design by  <a href="http://w3layouts.com/" target="_blank">Micheal And Christopher</a>Micheal And Christopher </p>
            </div>
        <div class="clearfix"> </div>
        </div>
    </div>
